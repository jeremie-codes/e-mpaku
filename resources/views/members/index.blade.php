                                    ...
                                    <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                                        <form class="create-form" action="{{ route('members.store') }}" id="create-form" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                                                ...
                                                <div class="xl:col-span-12">
                                                    <label for="ref" class="inline-block mb0 text-base font-medium">CIPA</label>
                                                ...
                                                <div class="xl:col-span-12">
                                                    <label for="sec_ref" class="inline-block mb0 text-base font-medium">Référence(optionnal)</label>
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form class="create-form" action="{{ route('members.store') }}" id="create-form" enctype="multipart/form-data" method="post">
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-12">
                            <label for="employeeId" class="inline-block mb0 text-base font-medium">CIPA</label>
                        ...
                        <div class="xl:col-span-12">
                            <label for="employeeId" class="inline-block mb0 text-base font-medium">Référence (optionnal)</label>
