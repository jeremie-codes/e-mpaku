...
@section('content')
<body
    class="flex items-center justify-center min-h-screen px-4 py-8 bg-cover bg-auth-pattern dark:bg-auth-pattern-dark dark:text-zink-100 font-public">
        ...
        <div class="grid grid-cols-1 gap-0 lg:grid-cols-12">
            <div class="lg:col-span-5">
                <div class="!px-10 !py-12 card-body">
                    ...
                    <div>
                        <form method="POST" action="{{ route('admin.store') }}" class="mt-10">
                            @csrf
                            <div class="mb-3">
            ...
            <div class="mx-2 mt-2 mb-2 border-none shadow-none lg:col-span-7 card bg-white/60 dark:bg-zink-500/60">
                <div class="!px-10  h-full !pb-0 card-body flex flex-row items-center justify-center">
                    <div class="mt-auto">
